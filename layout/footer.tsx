...
<div className="md:max-w-[1250px] m-auto rounded-t-2xl md:rounded-2xl flex flex-col lg:flex-row p-5 md:p-15 items-stretch gap-6 bg-[#1d546b]">
          ...
          <div className="flex mt-10 md:justify-start justify-center">
            ...
            <div className="flex flex-col gap-3 mr-5 md:mr-10">
              ...
              {[
                ...
                { label: "خبرنامه وبوفن", href: "/articles" },
        ...
        <div className="md:w-[40%] flex flex-col gap-4">
          <div className="text-gray-50 text-start">
            <p className="text-lg">مشاوره با وبوفن</p>
            <p className="text-sm text-gray-100 mt-4">
              جهت مشاوره با متخصصین مجرب ما
            </p>

            <input
              type="text"
              placeholder="شماره خود را وارد کنید"
              className="w-full mt-4 p-3 text-sm rounded-md bg-[#153e4c] text-gray-50 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500 transition"
            />
          </div>
                ...
                >
                  <g id="Layer_1-2" data-name="Layer 1">
                    <g>
                      ...
                      />
                      <path
                        d="M15.48,0h0C6.93,0,0,6.93,0,15.48h0c0,8.55,6.93,15.48,15.48,15.48h0c8.55,0,15.48-6.93,15.48-15.48h0C30.96,6.93,24.03,0,15.48,0ZM25.33,19.6c-.05,1.07-.22,1.8-.47,2.43-.26.66-.6,1.22-1.16,1.78-.56.56-1.12.9-1.78,1.16-.64.25-1.37.42-2.43.47-1.07.05-1.41.06-4.13.06s-3.06-.01-4.13-.06c-1.07-.05-1.8-.22-2.43-.47-.66-.26-1.22-.6-1.78-1.16-.56-.56-.9-1.12-1.16-1.78-.25-.64-.42-1.37-.47-2.43-.05-1.07-.06-1.41-.06-4.13s.01-3.06.06-4.13c.05-1.07.22-1.8.47-2.43.26-.66.6-1.22,1.16-1.78s1.12-.9,1.78-1.16c.64-.25,1.37-.42,2.43-.47,1.07-.05,1.41-.06,4.13-.06s3.07.01,4.13.06c1.07.05,1.8.22,2.43.47.66.26,1.22.6,1.78,1.16.56.56.9,1.12,1.16,1.78.25.64.42,1.37.47,2.43.05,1.07.06,1.41.06,4.13s-.01,3.06-.06,4.13h0ZM23.18,9.55c-.18-.47-.4-.8-.75-1.15-.35-.35-.69-.57-1.15-.75-.35-.14-.88-.3-1.86-.34-1.06-.05-1.38-.06-4.05-.06s-2.99.01-4.05.06c-.98.04-1.51.21-1.86.34-.47.18-.8.4-1.15.75-.35.35-.57.69-.75,1.15-.14.35-.3.88-.34,1.86-.05,1.06-.06,1.37-.06,4.05s.01,2.99.06,4.05c.05.98.21,1.51.34,1.86.18.47.4.8.75,1.15.35.35.69.57,1.15.75.35.14.88.3,1.86.35,1.06.05,1.37.06,4.05.06s3-.01,4.05-.06c.98-.05,1.51-.21,1.86-.35.47-.18.8-.4,1.15-.75s.57-.69.75-1.15c.14-.35.3-.88.34-1.86.05-1.06.06-1.38.06-4.05s-.01-2.99-.06-4.05c-.05-.98-.21-1.51-.34-1.86h0ZM15.37,20.61c-2.84,0-5.15-2.31-5.15-5.15s2.31-5.15,5.15-5.15,5.15,2.31,5.15,5.15-2.31,5.15-5.15,5.15h0ZM20.72,11.31c-.66,0-1.2-.54-1.2-1.2s.54-1.2,1.2-1.2,1.2.54,1.2,1.2-.54,1.2-1.2,1.2h0Z"
                        fill="#b3c0c9"
                        opacity={0.5}
                      />
                    </g>
