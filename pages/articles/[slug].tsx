        ...
        <div className="relative pt-20">
            ...
            {post.imageUrl && (
              <div className="relative w-full h-[500px]">
                <Image
                  ...
                  loader={({ src }) => src}
                  fill
                  className="bg-gray-200 rounded-2xl object-cover"
                  priority
                />
              </div>
            )}
            ...
            <article className="w-full" itemScope itemType="https://schema.org/Article">
              <div className="w-full text-gray-700 m-auto">
                <div className="flex items-center mt-8">
                  ...
                  <p className="text-blue-500" itemProp="articleSection">
                    {post.category?.title}
                  </p>
                </div>
                <div className="">
                  <h1 className="text-gray-800 font-semibold mt-2 text-2xl" itemProp="headline">
                    {post.title}
                  </h1>
                </div>
                <div className="mt-5 flex items-center justify-between">
                  ...
                  <div>
                    ...
                    <meta itemProp="dateModified" content={post.updatedAt || post.createdAt} />
                    <span>
                      {post.createdAt
              ...
              <div itemProp="comment">
                ...
                />
                {/* اگر CommentsList نیاز به کامنت‌ها دارد، باید از prop مناسب استفاده شود */}
                <CommentsList 
                  contentType="post"
                  pageSlug={typeof slug === "string" ? slug : ""}
                />
          ...
          <div className="flex w-full m-auto justify-between content">
            <div className="text-gray-700 mt-6 w-4/5">
              {/* محتوای اصلی اینجا نمایش داده می‌شود */}
            </div>
              ...
              <div className="sticky top-2 space-y-6 justify-center">
                  ...
                  {post.toc && post.toc.length > 0 && (
                    <div className="toc-sidebar">
                      ...
                      <nav className="toc-nav text-sm">
                        <ul>
                          {[...post.toc].reverse().map((item, index) => (
                            <li
                              key={item.id || index}
                ...
                <div className="flex flex-wrap justify-center">
                  ...
                  <div className="w-full flex gap-6 p-2 mt-3 justify-center items-center">
                    <Link href={"/instagram"} aria-label="اشتراک گذاری در اینستاگرام">
                      <svg
                    ...
                    <Link href={"/twitter"} className="pt-2" aria-label="اشتراک گذاری در توییتر">
                      <svg
                    ...
                    <Link href="/linkedin" aria-label="اشتراک گذاری در لینکدین">
                      <svg
                    ...
                    <Link href="/telegram" aria-label="اشتراک گذاری در تلگرام">
                      <svg
                    ...
                    <Link href="/facebook" aria-label="اشتراک گذاری در فیسبوک">
                      <svg
