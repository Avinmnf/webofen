...
setDislikes((prev) => prev + 1);
  ...
  return (
    <main className="relative w-full">
      ...
      <div className="relative top-40 bg-gray-100 -skew-y-3 rounded-4xl">
        <div className="w-7/12 m-auto transform skew-y-3">
          {/* Hero Section */}
          {post.imageUrl && (
        ...
        <div className="w-3/5 justify-between mx-auto flex gap-8 px-4 mt-8 transform skew-y-3">
          {/* Post Content */}
...
<p className="text-blue-500">{post.category?.title}</p>
        ...
        <div className="flex w-3/5 m-auto justify-between transform skew-y-3">
