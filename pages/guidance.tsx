...
export default function guidance() {
 ...
 <div
                ...
                >
                  <HoverVideo
                    src="/guidance/Hailuo_Video_A_futuristic_glowing_capsule_s_420385176478949377.mp4"
                    className="h-full absolute left-0 w-auto object-cover"
                    ref={videoRef} // now works
                  />
                ...
                >
                  <HoverVideo
                    src="/guidance/Hailuo_Video_A_futuristic_glowing_pill_with_420392168333352962_3.mp4"
                    className="h-full absolute left-0 w-auto object-cover"
                    ref={videoRef} // now works
                  />
