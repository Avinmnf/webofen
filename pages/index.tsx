...
const organizationSchema = {
  ...
  sameAs: ["https://instagram.com/webofen", "https://t.me/webofen"],
  areaServed: {
    "@type": "Country",
    name: "Iran",
  },
...
<svg
    ...
    c0-5.73,4.66-10.39,10.39-10.39c.82,0,1.48.66,1.48,1.48Z"
          ...
          <div className="flex flex-col lg:flex-row gap-8 justify-center mx-auto items-centerY">
            ...
            <div className="w-full lg:w-7/12">
              ...
              <p className="pt-6 text-sm md:text-sm text-gray-600 leading-relaxed text-justify">
                <strong>می‌خواهید وبسایت شما در صفحه اول گوگل دیده شود؟</strong>{" "}
                با تحلیل تخصصی و برطرف کردن موانع سئوی سایتتان، مسیر موفقیت شما
                در جستجوها را هموار می‌کنیم.
              </p>
              <p className="pt-6 text-sm md:text-sm text-gray-600 leading-relaxed text-justify">
                وبوفن، اولین کلینیک تخصصی سئو است که با نسخه هوشمندانه،
                بیماری‌های وبسایتتان را درمان می‌کند. ما با ارائه "بسته‌های
                درمانی ماژولار" (مانند قرص بک‌لینک، قرص بهینه‌سازی و قرص بهینه
                سازی)، پیچیده‌ترین مفاهیم سئو را به ساده‌ترین و مؤثرترین
                راهکارها تبدیل کرده‌ایم. با تحلیل رایگان وبسایت توسط متخصصان ما،
                قرص های مناسب برای رشد کسب‌وکار خود را دریافت کنید.
              </p>
              ...
              <div className="grid md:flex w-full">
                <div className="w-full md:w-1/2">
                  <p className="pt-3 flex text-sm md:text-sm text-gray-600 leading-relaxed text-justify">
                    ...
                    مطابق با مشکلات دقیق وبسایتتان هزینه خواهید کرد.
                  </p>
                  <p className="pt-3 flex text-sm md:text-sm text-gray-600 leading-relaxed text-justify">
                    <svg
                      width="24px"
                    ...
                    مدیریت فرآیند سئو تحت اختیار شماست.
                  </p>
                  <p className="pt-3 flex text-sm md:text-sm text-gray-600 leading-relaxed text-justify">
                    <svg
                      width="24px"
                    ...
                    گزارشات لحظه ای از هر اقدام را در اختیار دارید.
                  </p>
                </div>
                <div className="w-full md:w-1/2">
                  <p className="pt-3 flex text-sm md:text-sm text-gray-600 leading-relaxed text-justify">
                    ...
                    امکان مدیریت و زمان بندی فرآیند ها وجود دارد.
                  </p>
                  <p className="pt-3 flex text-sm md:text-sm text-gray-600 leading-relaxed text-justify">
                    <svg
                      width="24px"
                    ...
                    از پشتیبانی تخصصی خدمات سئو بهره مند خواهید شد.
                  </p>
                  <p className="pt-3 flex text-sm md:text-sm text-gray-600 leading-relaxed text-justify">
                    <svg
                      width="24px"
                    ...
                    از دلایل کسب نتیجه مطلوب آگاه خواهید شد.
                  </p>
                </div>
              </div>
              {/* Footer */}
        ...
        <section
          ...
          style={{
            background:
              "linear-gradient(180deg,rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 1) 25%, rgba(247, 248, 252, 1) 25%, rgba(247, 248, 252, 1) 100%);",
          }}
        >
          ...
          <div className="max-w-[1250px] m-auto relative p-4 md:p-0">
            <div className="grid md:flex w-full md:h-[344] mb-0 md:mb-10 rounded-3xl bg-[#29b0cb] md:bg-white md:bg-[url(/homepage/bg1.webp)]">
              <div
                id="first"
                className="order-2 md:order-1 w-11/12 md:w-2/3 mx-auto-sm"
              >
                  ...
                  <div className="w-full px-6 py-2 md:p-6 md:w-1/2">
                    <div className="w-full border border-white hover:bg-[#1d546b] hover:border-[#1d546b] flex items-center text-white rounded-4xl p-4 h-full sm:w-auto text-center text-sm sm:text-base">
                      ...
                      <div className="text-start pr-5">
                        ...
                        <p className="text-sm">
                          بهینه‌ سازی سایت برای رشد پایدار در نتایج جستجو و جذب
                          مخاطبان هدف
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="w-full px-6 py-2 md:p-6 md:w-1/2">
                    <div className="w-full text-white flex items-center border border-white hover:bg-[#1d546b] hover:border-[#1d546b] rounded-4xl p-4 sm:w-auto text-center text-sm sm:text-base">
                      ...
                      <div className="text-start pr-5">
                        ...
                        <p className="text-sm">
                          از ایده تا اجرای وب‌ سایت؛ طراحی اصولی و کاربر پسند با
                          جدید ترین استاندارد های وب
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="w-full  relative ">
            <div className="max-w-[1250px] p-8 md:p-0 mx-auto">
              <div className="flex items-center justify-center md:justify-start">
                ...
                <h2 className="text-[#6FD6E5] font-semibold pr-2 text-lg">
                  وبوفن
                </h2>
              </div>
              <Popularpills />
            ...
            <div className="w-full md:w-[40%] flex justify-center items-center text-center md:text-right mt-30">
              <div>
                <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-4">
                  مشتریان ، درباره <span className="text-[#3db4c6]">وبوفن</span>{" "}
                  چه می‌گویند ؟
                </h2>
                <p className="text-sm text-gray-600 leading-relaxed">
                  ما در وبوفن همواره سعی کرده‌ایم خدماتی ارائه دهیم که مشتریان
                  را راضی کند و تجربه‌ای مثبت برای آن‌ها بسازد. با وجود تلاش
                  مستمر، می‌دانیم که همیشه جای پیشرفت هست و بازخوردهای ارزشمند
                  شما راهنمای ما برای بهتر شدن است.
                </p>
              </div>
            </div>
