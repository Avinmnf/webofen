  ...
  return (
    <main className="">
      <section className="bg-[#f7f8fc] flex justify-center">
        <div className="flex flex-col-reverse lg:flex-row w-11/12 justify-center items-center gap-8">
          ...
          <div className="relative w-full lg:w-2/5 aspect-[4/3] rounded-lg overflow-hidden">
            <Image
    ...
    c0-5.73,4.66-10.39,10.39-10.39c.82,0,1.48.66,1.48,1.48Z"
          ...
          <div className="w-11/12 flex flex-col gap-4 lg:flex-row lg:items-center justify-between rounded-2xl bg-white p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
              <input
                ...
                className="bg-[#f7f8fc] rounded-lg p-2 px-4 text-sm"
              />
              <input
                type="text"
      ...
      <section>
        <div className="w-full mt-10">
          <div className="flex flex-row gap-6 justify-center w-11/12 m-auto">
            <div className="w-5/12">
              <div className="relative w-full aspect-[16/10] rounded-lg overflow-hidden flex items-start">
                <Image
            ...
            <div className="w-7/12">
              <div className="flex items-start">
                ...
                <div className="mr-4">
                  <p className="text-[#1d546b] text-lg">درباره ما</p>
                  <div className="flex items-center">
                    <p className="text-gray-800 text-lg">مرکز تخصصی درمان</p>
                    <p className="text-[#1d546b] text-lg pr-2">وب سایت</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mt-10">
                <div className="flex items-center">
                  ...
                  <div className="mr-4">
                    <p className="text-gray-800 text-md">دکتر مجتبی خداخواه</p>
                    <p className="text-[#6FD6E5] text-sm">متخصص سئو سایت</p>
                  </div>
                </div>
                <div className="w-full lg:w-auto">
                  <button className="w-full lg:w-32 h-10 bg-[#6FD6E5] text-white rounded-lg mt-2 lg:mt-0">
              ...
              <div className="absolute top-4 right-4 flex items-start z-10 p-4 rounded-xl max-w-[90%]">
                ...
                <div className="mr-4">
                  ...
                  <div className="flex flex-wrap items-center mt-1">
                    <p className="text-gray-800 text-2xl">خدمات تخصصی کلینیک</p>
                    <p className="text-[#6FD6E5] text-2xl pr-2">وب و فن</p>
                  </div>
                </div>
              </div>
