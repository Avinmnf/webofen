...
export default function FreeConsultationForm() {
  ...
  return (
    ...
    className=" bg-[#f7f8fc]  rounded-lg px-7 py-2 text-sm border border-transparent focus:outline-none focus:border-[#6FD6E5] focus:ring-2 focus:ring-[#6FD6E5] transition-all duration-200"
          value={name}
    ...
    className=" bg-[#f7f8fc] rounded-lg px-8 py-2 text-sm border border-transparent focus:outline-none focus:border-[#6FD6E5] focus:ring-2 focus:ring-[#6FD6E5] transition-all duration-200"
          value={phone}
