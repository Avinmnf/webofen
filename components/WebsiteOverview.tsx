  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 animate-slide-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* آدرس وبسایت */}
        <div className="flex items-center p-4 bg-gradient-to-r from-blue-50 to-blue-50 rounded-xl border border-blue-100 transition-all hover:shadow-md hover:scale-105">
        ...
        {/* وضعیت آنالیز */}
        <div className="flex items-center p-4 bg-gradient-to-r from-green-50 to-green-50 rounded-xl border border-green-100 transition-all hover:shadow-md hover:scale-105">
