        ...
        <div className="absolute top-50 md:top-6 right-4 items-start z-10 p-10 md:p-4 pt-10 rounded-xl">
          <div className="mt-10">
            <p className="text-lg md:text-3xl text-white mb-4">
              ...
              <span className="text-[#1d546b] font-semibold"> مشاوره رایگان </span>
              دریافت کنید :
            </p>
          </div>
          ...
          <div className="flex gap-4 w-full items-center mt-10">
            <input
              ...
              className="flex-1 bg-[#f7f8fc] text-gray-700 rounded-lg p-2 px-4 text-sm border border-transparent focus:outline-none focus:border-[#1d546b] focus:ring-2 focus:ring-[#1d546b] transition-all duration-200"
            />
            <input
              type="text"
