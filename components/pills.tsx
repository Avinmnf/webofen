...
export default function Pills() {
  ...
  const data = [
    ...
    },
    {
      ...
      desc: "سئو داخلی سایت",
      type: "onpage",
      link: "/guidance/internal-linking",
    },
    {
