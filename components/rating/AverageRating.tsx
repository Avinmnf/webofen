...
export default function AverageRating({
  ...
  if (loading) return <p className="text-gray-500 text-sm text-center">در حال بارگذاری...</p>;
  if (!rating || rating.totalRatings === 0)
    return <p className="text-gray-500 text-sm text-center">بدون امتیاز</p>;
  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <span className="text-sm text-gray-500">({totalRatings} رأی)</span>
    </div>
  );
}
